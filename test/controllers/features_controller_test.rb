...
class FeaturesControllerTest < ActionController::TestCase
  ...
  test "should create feature" do
    assert_difference('Feature.count') do
      post :create, feature: { free_tier: @feature.free_tier, name: @feature.name, paid_tier: @feature.paid_tier }
    end
  ...
  test "should update feature" do
    patch :update, id: @feature, feature: { free_tier: @feature.free_tier, name: @feature.name, paid_tier: @feature.paid_tier }
    assert_redirected_to feature_path(assigns(:feature))
  end
